...
|---------|------|-------------|
| DuraGraph | 8081 | Control plane REST API + embedded dashboard (same origin) |
...
- **DuraGraph API + Dashboard:** http://localhost:8081 (dashboard is embedded; same origin as the API)
