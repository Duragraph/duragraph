...
**v0.4.0** - In Active Development
**Installation**: `pip install duragraph`
**Repository**: [duragraph-python](https://github.com/Duragraph/duragraph/tree/main/python)
:::
...
Creates a node powered by a [DSPy](https://dspy.ai/) module. Requires `pip install duragraph[dspy]`.
...
DuraGraph integrates with [DSPy](https://dspy.ai/) to let you build nodes using DSPy's declarative programming model. This enables structured outputs, chain-of-thought reasoning, and optimizable prompts within your workflow graphs.
...
- [GitHub Repository](https://github.com/Duragraph/duragraph/tree/main/python)
