...
✅ **Open Source** - Self-host and customize Duragraph  
✅ **Cost Control** - No per-execution pricing  
✅ **Data Sovereignty** - Keep your data in your infrastructure  
✅ **Enterprise Features** - Coming in Duragraph Cloud  
...
✅ Migrate a simple workflow first  
✅ Test in staging environment  
✅ Monitor performance metrics  
✅ Gradually migrate production workflows  
✅ [Set up monitoring](../concepts/observability.md)  
✅ [Configure production deployment](../installation/self-hosted.md)
